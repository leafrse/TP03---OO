...
/**
 * @see idNome Nomes do produto
 * @see idTipo Tipo do produto
 * @see idCodP codigo do produto
 * @see idValor valor do produto
 * @see idSize tamanho da seringa
 * @see idExpess expessura de agulha da seringa
 * @see idFunc funcionalidade da toxina
 * @see idQntA quantidade por ampola Tela cujo a funcionalidade esta concentrada
 *      na funcionalidade de botoes, busca, edição e exclusão
...
//Labels e campos de texto para inserir as informações do produto
	...
	// Botões para excluir e salvar os dados
	...
	public void infoP(Controle Dados, int pos, int opcao) {
		...
		// Posicionamento dos labels e campos de texto na tela
...
//mensagens de indicação para exibir o sucesso ou fracasso da operação 
